...
Осенний семестр, 2023 год, гр. M8О-404Б-20
...
2. Нажать кнопку [Fork](https://github.com/calculation-methods/M08-404B-20/fork) на странице настоящего репозитория
3. Создать папку в корне собственного склонированного репозитория, назвав ее транслитерацией фамилии студента в нижнем регистре
...
3. Ожидать обратной связи от преподавателя (комментарии, замечания, вопросы, одобрения).
4. Учесть замечания, ответить на вопросы.
5. После одобрения работы преподавателем добавить ее в репозиторий.
